---
layout: post
title: "擎威 Ribose 成功將 BibXML 服務部署至 AWS EKS Fargate"
...
excerpt: >-
  擎威 Ribose 成功將 BibXML 服務部署至 AWS EKS Fargate
---
= 擎威 Ribose 成功將 BibXML 服務部署至 AWS EKS Fargate

本文中我們將使用
https://github.com/ietf-ribose/bibxml-service[BibXML Service]（基於 Django 的 Web 服務，實現 IETF BibXML API）作為範例，展示如何在 AWS EKS Fargate 中部署容器化的 Python 和 Django 應用程式。
