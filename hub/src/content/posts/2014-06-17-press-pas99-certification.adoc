...
*Hong Kong, 17 June 2014 –* http://www.ribose.com[Ribose] has achieved PAS 99:2012 certification, the internationally accepted framework for integrated management systems (IMS).
...
Ribose’s certification was awarded by http://www.bsigroup.com[BSI (British Standards Institution)], the originator of the PAS 99, ISO 22301 and ISO 27001 standards. Certification is awarded only after an independent accredited auditor has thoroughly checked all applications, systems, processes and services.
