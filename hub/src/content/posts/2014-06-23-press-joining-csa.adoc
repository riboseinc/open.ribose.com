...
*Hong Kong, 23 June 2014 –* http://www.ribose.com[Ribose], a start-up redefining the way people collaborate, has joined the Cloud Security Alliance (CSA) to help promote security in cloud computing. CSA developed the first industry-accepted standard for cloud security, the Cloud Controls Matrix (CCM), and its other members include tech luminaries such as Amazon, HP and Microsoft.
